            ...
            <div class="row">
                <form action="" method="POST" style="width: 50%; margin: 0 auto" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <label style="height: 50px;"  name="u_email" value="" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                               placeholder="Nhập email">{{ $user->u_email }}</label>

                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Họ và tên</label>
                        <label style="height: 50px;" class="form-control" name="u_name" value="" type="text" placeholder="Nhập họ và tên">{{ $user->u_name }}</label>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Tuổi</label>
                        <label style="height: 50px;" class="form-control" name="u_age" value="" type="number" >{{ $user->u_age }}</label>
                    </div>
